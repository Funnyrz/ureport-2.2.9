...
public class DesignerServletAction extends RenderPageServletAction {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(method!=null){
			...
			Template template=ve.getTemplate(webBasePath+"/ureport-html/designer.html","utf-8");
	 ...
	 * @throws IOException
	 */
	public void loadDataSourceInfo(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
