...
export default class RemoteDialog{
    ...
    initBody(body,footer){
        const table=$(`<table class="table table-bordered">
            <thead><tr style="background: #f4f4f4;height: 30px;"><td style="vertical-align: middle">${window.i18n.dialog.remoteDS.datasourceName}</td><td style="vertical-align: middle">${window.i18n.dialog.remoteDS.select}</td></tr></thead>
        </table>`);
            ...
            success: function (result) {
                ...
                for (let item of result.items) {
                    ...
                    selector.click(function(){
                        ...
                        onSelect.call(this, {"name":name,"id":id});
                        setDirty();
