...
import SelectDatasetDialog from '../dialog/SelectDatasetDialog.js';
    ...
    _buildDatasource() {
        ...
        const rootSpan = $(`
            <span id="${this.id}">
                ...
                <i class="ureport ureport-summary"></i> <a href='###' class="ds_name">${this.name}</a>
            </span>`);
        ...
        const selectDatasetDialog = new SelectDatasetDialog(this, {
            parameters: []
        });
        $.contextMenu({
            selector: '#' + this.id,
            callback: function (key, options) {
                if (key === 'select') {
                    ...
                    selectDatasetDialog.show(function (name, sql, parameters) {
                        const dataset = {
                            name,
                            sql,
                            parameters
