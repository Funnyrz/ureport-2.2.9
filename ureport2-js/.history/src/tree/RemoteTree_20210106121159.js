...
export default class DatabaseTree extends BaseTree {
    ...
    addDataset(dataset) {
        ...
        fieldsUL.append($(`<li style=""><span id="48e9b930-4fd4-11eb-958d-1f184dc1881d" title="双击添加字段到单元格" class=""><i class="ureport ureport-property"></i> <a href="###">LOG_NR_</a></span></li>`))
        li.append(fieldsUL);
        const _this = this;
