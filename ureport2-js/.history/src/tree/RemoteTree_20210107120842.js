...
export default class DatabaseTree extends BaseTree {
    ...
    addDataset(dataset,id) {
        ...
        const span = $(`<span id="${id}"><i class='ureport ureport-plus' style='margin-right:2px'></i> <i class="ureport ureport-sqlds"></i> <a href='###' class="dataset_name">${dataset.name}</a></span>`);
        li.append(span);
